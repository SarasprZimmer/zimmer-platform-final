...
Write-Host "`n👑 Admin Panel Build Check..." -ForegroundColor Cyan
try {
...
Write-Host "`n🗄️ Database Check..." -ForegroundColor Cyan
...
Write-Host "`n🔍 Critical API Endpoints..." -ForegroundColor Cyan
$criticalEndpoints = @(
...
Write-Host "`n🎯 SMOKE TEST STATUS:" -ForegroundColor Cyan
...
Write-Host "`n💨 Smoke Test completed at $(Get-Date)" -ForegroundColor Green
