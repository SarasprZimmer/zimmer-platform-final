Write-Host "== Admin Dashboard Endpoint Connectivity Test =="
Write-Host "=============================================="
...
# Step 3: Test Core Admin Endpoints
Write-Host "`nStep 3: Testing Core Admin Endpoints"
Write-Host "--------------------------------------"
...
# KB Monitoring
Test-AuthenticatedEndpoint -Name "Get KB Monitoring" -Method "GET" -Endpoint "/api/admin/kb-monitoring"

# Step 4: Test Specific Problem Areas
Write-Host "`nStep 4: Testing Problem Areas"
Write-Host "-------------------------------"
...
Write-Host "`n=============================================="
Write-Host "ENDPOINT CONNECTIVITY TEST SUMMARY"
Write-Host "=============================================="
...
if ($failedTests -gt 0) {
    ...
    foreach ($test in $testResults.GetEnumerator()) {
        if ($test.Value.Status -eq "FAILED") {
            Write-Host "  ❌ $($test.Key): $($test.Value.Error)" -ForegroundColor Red
        }
    }
}
