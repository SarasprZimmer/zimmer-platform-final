...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch((process.env.NEXT_PUBLIC_API_BASE_URL || process.env.NEXT_PUBLIC_API_URL || "${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_BASE_URL || "https://api.zimmerai.com"}") + "/api/auth/verify-email", {
          method: "POST",
