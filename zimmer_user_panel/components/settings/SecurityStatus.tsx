...
export default function SecurityStatus(){
  ...
  async function sendVerificationEmail() {
    ...
    setNote(null);
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_BASE_URL || "https://api.zimmerai.com"}"}/api/auth/send-email-verification`, {
        method: "POST",
        headers: { 
  ...
  async function verifyEmailCode() {
    ...
    setNote(null);
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "${process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_BASE_URL || "https://api.zimmerai.com"}"}/api/auth/verify-email`, {
        method: "POST",
        headers: { 
          "Content-Type": "application/json",
          "Authorization": `Bearer ${localStorage.getItem("access_token")}`
